...
final class RadialGradientPaintContext extends MultipleGradientPaintContext {
    ...
    public RadialGradientPaintContext(ColorModel cm, Rectangle deviceBounds, Rectangle2D userBounds, AffineTransform t,
        ...
        constA = a02 - centerX;
        constB = a12 - centerY;
        Object colorRend = hints != null ? hints.get(RenderingHints.KEY_COLOR_RENDERING) : null;
        Object rend = hints != null ? hints.get(RenderingHints.KEY_RENDERING) : null;
        fillMethod = 0;
        ...
        for (j = 0; j < h; j++) { // for every row
            ...
            for (end = indexer + w; indexer < end; indexer++) {
                ...
                //  }
                    ...
                    if (0 <= gIndex && gIndex < gradient.length) {
                        pixels[indexer] = gradient[gIndex];
                    } else {
                        // does happen on webmichl/webmichl_light_shadow.svg
                        pixels[indexer] = gradientUnderflow;
                    }
                }
