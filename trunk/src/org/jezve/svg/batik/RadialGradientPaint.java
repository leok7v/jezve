...
public final class RadialGradientPaint extends MultipleGradientPaint {
    ...
    public PaintContext createContext(ColorModel cm, Rectangle deviceBounds, Rectangle2D userBounds,
        ...
        try {
            ...
            // ted/ted_Hexagon_background.svg
            // System.err.println("WARNING: transform should be invertible: " + transform);
            // ignore and use IDENTITY instead
        }
        // use IDENTITY instead
        try {
            return new RadialGradientPaintContext(cm, deviceBounds, userBounds, GraphicsUtil.IDENTITY, hints, (float)center.getX(),
                    (float)center.getY(), radius, (float)focus.getX(), (float)focus.getY(), fractions, colors,
                    cycleMethod, colorSpace);
        } catch (NoninvertibleTransformException e) {
            throw new Error(e);
