...
public class GraphicsUtil {
    ...
    public static final Rectangle2D.Float EMPTY_BOX = new Rectangle2D.Float();
    ...
    public static boolean is_INT_PACK_Data(SampleModel sm, boolean requireAlpha) {
        ...
        return masks[0] == 0x00ff0000 && masks[1] == 0x0000ff00 && masks[2] == 0x000000ff &&
                !((masks.length == 4) && (masks[3] != 0xff000000));
    }
